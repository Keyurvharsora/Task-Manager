        ...
        <form onSubmit={handleSubmit} className="max-w-lg mx-auto">
          ...
          <div className="mb-4">
            ...
            <textarea
              ...
              onChange={handleChange}
              rows="5"
              className="w-full px-4 py-2 border rounded-md resize-none focus:outline-none focus:ring focus:border-green-500"
              required
            />
          </div>
          <div className="text-center">
            <button
              type="submit"
              className="bg-green-500 text-white px-6 py-3 rounded-md shadow-md hover:shadow-lg transition duration-300"
            >
              Submit
            </button>
          </div>
