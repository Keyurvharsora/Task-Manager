...
const ActionSection = () => {
  return (
    <div className="relative bg-green-500 text-white py-20">
      <div className="absolute top-0 left-0 w-full h-full z-10 bg-opacity-70 bg-green-500"></div>
      <div className="container mx-auto text-center relative z-20">
        ...
        <button
          className="bg-white text-green-500 py-3 px-6 rounded-md shadow-md hover:shadow-lg transition duration-300"
          onClick={() => {
